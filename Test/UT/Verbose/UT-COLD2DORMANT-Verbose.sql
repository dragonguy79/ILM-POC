...
select TABLE_NAME, partition_name, tablespace_name  from USER_TAB_PARTITIONS where table_name in ('PAYMENTINTERCHANGEP2015_10','PAYMENTINTERCHANGEP2015_11'); 


-- test that the moved subpartition are gone
  -- assert: no subpartition found for partition P2015_11
select TABLE_NAME, partition_name, tablespace_name  from USER_TAB_SUBPARTITIONS where partition_name in ('P2015_10', 'P2015_11');
...
select  TABLE_NAME, column_name, partition_name, LOB_PARTITION_NAME, tablespace_name from USER_LOB_PARTITIONS where table_name in ('PAYMENTINTERCHANGEP2015_10','PAYMENTINTERCHANGEP2015_11'); 

-- test that no lob exist anymore in partition P2015_11
select  TABLE_NAME, column_name, partition_name, LOB_PARTITION_NAME, tablespace_name from USER_LOB_PARTITIONS where partition_name in ('P2015_10', 'P2015_11');
...
where l.table_name  in ('PAYMENTINTERCHANGEP2015_10','PAYMENTINTERCHANGEP2015_11'); 
...
where ti.table_name in ('PAYMENTINTERCHANGEP2015_10','PAYMENTINTERCHANGEP2015_11'); 
