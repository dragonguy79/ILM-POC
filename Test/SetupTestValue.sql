...
update TPAYMENTINTERCHANGE set ILMKEY = add_months(ILMKEY,-1) where PAYMENTINTERCHANGEKEY <= 1530102;
update TPAYMENTINTERCHANGE set ILMKEY = add_months(ILMKEY,1) where PAYMENTINTERCHANGEKEY >= 1530109;
commit;
