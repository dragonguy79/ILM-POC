...
-----------------------------------------------------------------------------------------------------------------
  ...
  ILM_TEST.TEST_SQL_COUNT(32, 'SELECT COUNT(*)  FROM USER_TAB_PARTITIONS WHERE table_name in (''PAYMENTINTERCHANGEP2015_10'',''PAYMENTINTERCHANGEP2015_11'') AND TABLESPACE_NAME = ''ILM_DORMANT_TBS''');
...
-----------------------------------------------------------------------------------------------------------------
  ...
  ILM_TEST.TEST_SQL_COUNT(96, 'SELECT COUNT(*)  FROM USER_LOB_PARTITIONS WHERE table_name in (''PAYMENTINTERCHANGEP2015_10'',''PAYMENTINTERCHANGEP2015_11'')  AND tablespace_name=''ILM_DORMANT_TBS''');
  ...
  ILM_TEST.TEST_SQL_COUNT(96, 'SELECT COUNT(*) from USER_IND_PARTITIONS ind inner join USER_LOBS l on ind.index_name = l.INDEX_NAME where l.table_name in (''PAYMENTINTERCHANGEP2015_10'',''PAYMENTINTERCHANGEP2015_11'') AND ind.TABLESPACE_NAME=''ILM_DORMANT_TBS'' AND l.TABLESPACE_NAME=''ILM_DORMANT_TBS''');    
...
-----------------------------------------------------------------------------------------------------------------
  ...
  ILM_TEST.TEST_SQL_COUNT(96, 'SELECT COUNT(*) from USER_IND_PARTITIONS pi inner join USER_INDEXES ti on pi.index_name = ti.index_name where ti.table_name in (''PAYMENTINTERCHANGEP2015_10'',''PAYMENTINTERCHANGEP2015_11'')');
  ...
  ILM_TEST.TEST_SQL_COUNT(0, 'SELECT COUNT(*) from USER_IND_SUBPARTITIONS spi inner join USER_INDEXES ti on spi.index_name = ti.index_name where ti.table_name in (''PAYMENTINTERCHANGEP2015_10'',''PAYMENTINTERCHANGEP2015_11'')');
