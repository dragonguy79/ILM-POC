...
INSERT INTO ILMCONFIG (ID, PARAM, VALUE, LASTMODIFIED) VALUES (-7, 'OVERWRITE_JOB_TIMESTAMP', '8-JAN-16 05.34.54.944651000 PM', SYSTIMESTAMP);
...
VALUES (-1, 'TPAYMENTINTERCHANGE', 'TPAYMENTINTERCHANGETEMP', 'TPAYMENTINTERCHANGECOLD', 1, 1, 1, 'BASIC', 'OLTP', 'OLTP', 1, null, null, null, sysdate);

INSERT INTO ILMMANAGEDTABLE(ID, TABLENAME, TEMPTABLENAME, COLDTABLENAME, HOTRETENTION, WARMRETENTION, COLDRETENTION, WARMCOMPRESSION, COLDCOMPRESSION, DORMANTCOMPRESSION, MOVESEQUENCE, HOTSTATUS, WARMSTATUS, COLDSTATUS, LASTMODIFIED)
VALUES (-2, 'TPAYMENTTRANSACTION', 'TPAYMENTTRANSACTIONTEMP', 'TPAYMENTTRANSACTIONCOLD', 1, 1, 1, 'BASIC', 'OLTP', 'OLTP', 2, null, null, null, sysdate);
commit;
