...
CREATE TABLE "ILMLOG" (	
  ...
  "TASKID" NUMBER(38,0) NOT NULL, 
	"LOG" VARCHAR2(128 CHAR) NOT NULL, 
  "WHENCREATED" TIMESTAMP  NOT NULL,
  CONSTRAINT ILMLOG_PK PRIMARY KEY (ID),
  CONSTRAINT FK_ILMLOG_ILMTASK FOREIGN KEY (TASKID) REFERENCES ILMTASK(ID)
);
...
CREATE TABLE "ILMMANAGEDTABLE" (	
  ...
  "HOTRETENTION" NUMBER(2,0) NOT NULL,
  "WARMRETENTION" NUMBER(2,0) NOT NULL,
  "COLDRETENTION" NUMBER(2,0) NOT NULL,
