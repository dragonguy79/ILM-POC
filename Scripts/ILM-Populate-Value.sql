...
(	 
     ...
     ILMKEY                 TIMESTAMP default systimestamp,
...
INSERT INTO ILMMANAGEDTABLE(ID, TABLENAME, COLDTABLENAME, HOTRETENTION, WARMRETENTION, COLDRETENTION, WARMCOMPRESSION, COLDCOMPRESSION, DORMANTCOMPRESSION, MOVESEQUENCE, LASTPARTITIONMOVE, LASTMOVEDATE, STATUS, LASTMODIFIED)
VALUES (ILMMANAGEDTABLE_SEQUENCE.nextval, 'PAYMENTINTERCHANGE',  'PAYMENTINTERCHANGECOLD', 1, 1, 2, null, null, null, 1, null, null, null, sysdate);
