...
SUBPARTITION BY HASH(PAYMENTINTERCHANGEKEY) SUBPARTITIONS 16
(
    PARTITION PC2015_10 VALUES LESS THAN (TO_DATE('2015-11-01', 'yyyy-MM-dd')),
    PARTITION PC9999_12 VALUES LESS THAN (MAXVALUE)
);
...
INSERT INTO ILMCONFIG (ID, PARAM, VALUE, LASTMODIFIED) VALUES (ILMCONFIG_SEQUENCE.nextval, 'DORMANT_TABLESPACE_PREFIX', 'ILM_DORMANT_TBS_', SYSTIMESTAMP);
INSERT INTO ILMCONFIG (ID, PARAM, VALUE, LASTMODIFIED) VALUES (ILMCONFIG_SEQUENCE.nextval, 'PARALLEL_DEGREE', '4', SYSTIMESTAMP);
INSERT INTO ILMCONFIG (ID, PARAM, VALUE, LASTMODIFIED) VALUES (ILMCONFIG_SEQUENCE.nextval, 'ONLINE_MOVE', 'TRUE', SYSTIMESTAMP);

INSERT INTO ILMMANAGEDTABLE(ID, TABLENAME, COLDTABLENAME, HOTRETENTION, WARMRETENTION, COLDRETENTION, WARMCOMPRESSION, COLDCOMPRESSION, DORMANTCOMPRESSION, MOVESEQUENCE, HOTSTATUS, WARMSTATUS, COLDSTATUS, LASTMODIFIED)
VALUES (ILMMANAGEDTABLE_SEQUENCE.nextval, 'PAYMENTINTERCHANGE',  'PAYMENTINTERCHANGECOLD', 1, 2, 3, 'OLTP', 'OLTP', 'OLTP', 1, null, null, null, sysdate);
commit;
