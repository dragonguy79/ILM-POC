create or replace PACKAGE ILM_CORE AS 
  ...
  ILMTABLESTATUS_PARTITIONMOVE CONSTANT VARCHAR2(15) := 'DATA_STALE';
  ILMTABLESTATUS_LOBMOVE CONSTANT VARCHAR2(15) := 'LOB_STALE';
  ILMTABLESTATUS_INDEXREBUILD CONSTANT VARCHAR2(15) := 'INDEX_STALE';
  ...
  FUNCTION GET_RESUME_PARTITION_SEQUENCE(I_STEP_ID in VARCHAR2) RETURN NUMBER;
  
  
  -- data
  PROCEDURE MOVE_PARTITION(I_TABLE_NAME in VARCHAR2, I_FROM_TBS in VARCHAR2, I_TO_TBS in VARCHAR2, COMPRESSION_CLAUSE in VARCHAR2 DEFAULT '');
  PROCEDURE MOVE_SUBPARTITION(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2, I_FROM_TBS in VARCHAR2, I_TO_TBS in VARCHAR2, COMPRESSION_CLAUSE in VARCHAR2 DEFAULT '');
