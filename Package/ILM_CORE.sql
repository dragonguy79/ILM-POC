create or replace PACKAGE ILM_CORE AS 
  ...
  PROCEDURE MOVE_SUBPARTITIONED_LOBS(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2);
  
  PROCEDURE REBUILD_GLOBAL_INDEX(TABLE_NAME in VARCHAR2);
  PROCEDURE REBUILD_PARTITIONED_INDEX(TABLE_NAME in VARCHAR2);
  PROCEDURE MOVE_SUBPARTITIONED_INDEXES(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2);
