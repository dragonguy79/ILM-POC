create or replace PACKAGE ILM_CORE AS 
  ...
  PROCEDURE MOVE_EXPIRED_PARTITIONS(I_TABLE_NAME in VARCHAR2);
  PROCEDURE MOVE_SUBPARTITIONS(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2);
  
  PROCEDURE MOVE_EXPIRED_LOB(I_TABLE_NAME in VARCHAR2);
  PROCEDURE MOVE_SUBPARTITIONED_LOBS(I_TABLE_NAME in VARCHAR2, I_LOB_PARTITION_NAME in VARCHAR2);
