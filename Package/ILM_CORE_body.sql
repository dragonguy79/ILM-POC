create or replace PACKAGE ILM_CORE AS 
  ...
  PROCEDURE MOVE_SUBPARTITIONED_LOB(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2);
  
  PROCEDURE REBUILD_GLOBAL_INDEX(I_TABLE_NAME in VARCHAR2);
  PROCEDURE REBUILD_MOVE_SUBPART_INDEX(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2);
  ...
  PROCEDURE MODIFY_PARTITION_TBS_ATTRIBUTE(I_TABLE_NAME in VARCHAR2, I_PARTITION_NAME in VARCHAR2); 
